...
#Load Functions:
 Functions
```{r}
source("Z:/Scripts/FronteraCodez/Functions/Find_Nearest_Cell_BC.R")
source("Z:/Scripts/FronteraCodez/Functions/Improved_CFIS_perrakis_function.R")
source("Z:/Scripts/FronteraCodez/Functions/Prob_Crown_Function_Perrakis2023.R")
source("Z:/Scripts/FronteraCodez/Functions/fueltypes_crosswalkFBP_function.R")
source("Z:/Scripts/FronteraCodez/Functions/fueltypes_crosswalk_function.R")
source("Z:/Scripts/FronteraCodez/Functions/fueltypes_crosswalkFBP_Raster_function.R")
source("Z:/Scripts/FronteraCodez/Functions/Crown_Area_Function.R")
source("Z:/Scripts/FronteraCodez/Functions/Get_Season_Function.R")
source("Z:/Scripts/FronteraCodez/Functions/FMC_Function.R")
source("Z:/Scripts/FronteraCodez/Functions/SFC_Function.R")
source("Z:/Scripts/FronteraCodez/Functions/Fine_Fuel_MC_SA_function.R")
source("Z:/Scripts/FronteraCodez/Functions/initial_spread_index.R")
source("Z:/Scripts/FronteraCodez/Functions/fire_behavior_prediction_function.R")
source("Z:/Scripts/FronteraCodez/Functions/Flaming_Ign_Probability_Function.R")
source("Z:/Scripts/FronteraCodez/Functions/Ignition_Probability_Function.R")
source("Z:/Scripts/FronteraCodez/Functions/CanFuel_Raster_Function.R")
source("Z:/Scripts/FronteraCodez/Functions/FMC_Raster_Function.R")
source("Z:/Scripts/FronteraCodez/Functions/ISI_Raster_Function.R")
source("Z:/Scripts/FronteraCodez/Functions/Flaming_Ign_Probability_Raster_Function.R")
source("Z:/Scripts/FronteraCodez/Functions/FFMC_sa_Raster_Function.R")
source("Z:/Scripts/FronteraCodez/Functions/CFIS_Modified_Raster_Function.R")
source("Z:/Scripts/FronteraCodez/Functions/Fire_Behavior_Pred_Rast_cffdrs_function.R")
source("Z:/Scripts/FronteraCodez/Functions/Residence_Time_Function_Nelson2003b.R")
source("Z:/Scripts/FronteraCodez/Functions/surface_fuel_consumption_CANFBP_function.R")
source("Z:/Scripts/FronteraCodez/Functions/WindGust_Function.R")
source("Z:/Scripts/FronteraCodez/Functions/rothermel_function_mod.R")
source("Z:/Scripts/FronteraCodez/Functions/Select_Best_Fuel_Model_Rothermel.R")
source("Z:/Scripts/FronteraCodez/Functions/BC_TREECODES_USCodes_function.R")
source("Z:/Scripts/FronteraCodez/Functions/CFC_Groot_Function.R")
```
...
template_file <- readLines("Z:/Scripts/FronteraCodez/Modeling Templates/Modeling/FuelCalcBC_Template_FCP.fcp")
...
ffi_temp<- readLines("Z:/Scripts/FronteraCodez/Modeling Templates/Modeling/FuelCalc_FFI_Template.ffi")
treatment_temp<-read.csv("Z:/Scripts/FronteraCodez/Modeling Templates/Modeling/Treatment_Template_FuelCalc.csv")
tre_temp<-readLines("Z:/Scripts/FronteraCodez/Modeling Templates/Modeling/FuelCalc_TRE_Template.tre")
...
# Read the template file
template_file <- readLines("Z:/Scripts/FronteraCodez/Modeling Templates/Modeling/FuelCalc_Template_FCP.fcp")
...
for(i in 1:nrow(daily_weather)) {
  ...
  # Construct file path
  file_path <- paste0("Z:/General-GIS/Holden's Data/Grass Curing/BC Rasters/pc", 
                      date_string, ".tif")
...
#Choose American NFFDRS Model
  ...
  CustomModels<-read.csv(paste0("Z:/Scripts/FronteraCodez/Modeling Templates/Modeling/CustomFuelModels.csv"))
...
source("Z:/Scripts/FronteraCodez/Functions/Improved_CFIS_perrakis_function.R")
source("Z:/Scripts/FronteraCodez/Functions/Crosswalk CAN to US Fuel Model Function.R")
source("Z:/Scripts/FronteraCodez/Functions/CFIM_Cruz2006_Function.R")
