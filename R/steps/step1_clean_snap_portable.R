...
# library(plyr)  # dropped for portability
#library(rspatial)
library(stringr)
library(magrittr)
library(dplyr)
# library(tidyverse)  # dropped for portability
library(dplyr)
library(magrittr)
# library(plyr)  # dropped for portability
# library(ggplot2)  # dropped for portability
# library(grid)  # dropped for portability
library(tidyr)
# library(readxl)  # dropped for portability
# library(GA)  # dropped for portability
# library(ftsa)  # dropped for portability
#install.packages("Rothermel")
# library(xlsx)  # dropped for portability
# library(devtools)  # dropped for portability
# library(geostats)  # dropped for portability
# library(plantecophys)  # dropped for portability
# library(progress)  # dropped for portability
# library(ggstatsplot)  # dropped for portability
# library(ggridges)  # dropped for portability
#install.packages("hrbrthemes")
#library(hrbrthemes)
# library(ggdist)  # dropped for portability
# library(MetBrewer)  # dropped for portability
# library(progress)  # dropped for portability
# library(DBI)  # dropped for portability
# library(RSQLite)  # dropped for portability
library(glue)
# library(rootSolve)  # dropped for portability
# library(progress)  # dropped for portability
# library(rlang)  # dropped for portability
# library(ggstatsplot)  # dropped for portability
library(glue)
...
## -----------------------------------------------------------------------------
if(FALSE){
AOI<-sf::st_read(paste0(path,"/TR__LionsBurn_BOX.shp"))
ft_raw<-sf::st_read(paste0(path,Fuel_prefix,"ft_raw.shp"))
